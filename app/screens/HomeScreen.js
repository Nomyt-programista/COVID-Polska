...
import WigetInfo from "../components/WigetInfo";
...
const styles = StyleSheet.create({
  ...
  data: {
    ...
    backgroundColor: colors.bgColor,
    height:
      (Dimensions.get("screen").height - Dimensions.get("screen").width) * 1.4,
    width: Dimensions.get("screen").width,
    flexDirection: "row",
    flexWrap: "wrap",
  },
